...
VERSION = ("🌳*Weed Grow*🌳\n_{n}_\n\n"
           + "• Увеличен показ топ-игроков в Рейтинге до 10;\n"
           + "• Добавлена информация о балансе перед выходом на Улицу;\n"
           + "• Из фермы удалена информация о последней дате сбора урожая;\n"
           + "• Изменена кнопка Реферальной Программы;\n"
...
STREET_ENTER_HIGH_TEXT = ("На *Улицу* можно выходить, имея как *минимум 1000*🌳 и *100*💰.\n\n"
                          + "{money}\n{high}\n\nВведите количество 🌳,"
                          + " которое задумали продать подороже:").format(money=MONEY_ON_STOCK, high=HIGH_ON_STOCK)
