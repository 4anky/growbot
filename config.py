...
SELL_GOODS = ((DEALER_BUTTON, STREET_BUTTON),
              (BACK_BUTTON, EMPTY_BUTTON))
STREET_PLACES = ((CENTRE_BUTTON, OUTSKIRTS_BUTTON),
                 (BACK_BUTTON, EMPTY_BUTTON))
...
STREET_ENTER_HIGH_TEXT = ("На *Улицу* можно выходить, имея как *минимум 1000* 🌳.\n"
                          + "Введите количество 🌳, которое задумали продать подороже:")
STREET_CHOICE_PLACE = (STREET_BUTTON.join("**")
                       + "\n\nПопытайте удачу и продайте готовый 🌳 урожай на улицах города. "
                       + "Будьте начеку: можно нарваться на *полицейский 🚔 патруль*.\n\n"
                       + "*Выберите место для сбыта*:\n"
                       + CENTRE_BUTTON.join("**")
                       + "         *30*💰 за *1000*🌳   шанс погореть *30%*\n"
                       + OUTSKIRTS_BUTTON.join("**")
                       + "   *60*💰 за *1000*🌳   шанс погореть *60%*\n\n"
                       + "_Совет:_  Если Вас словит патруль -"
                       + " попробуйте от него 💸 откупиться."
                       )
