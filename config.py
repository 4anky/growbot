...
TRAIN_DESC_1_TEXT = ("*⚠Главное⚠*\n\nВ этой игре Вы развиваете своё дело по выращиванию и продаже 🌳 шишек  - "
                     ...
                     + " 👳🏻‍♂ *Дилера* или самостоятельно, зарабатывая при этом некислые 💰 бабки.\n\nНо не всё"
                     + " так просто. Вы можете просадить весь капитал в 🎰 *Casino*, при продаже Вас может поймать"
                     + " полицейский 🚔 патруль. В самом худшем случае к Вам домой с обыском может заявиться майор"
                     + " 👮🏽‍♂ Крепилов, тогда придётся действовать быстро и без раздумий.\n\nВ общем, нет времени "
                     + "объяснять! Жми на 🐲 и покупай свою первую установку для выращивания!")
TRAIN_DESC_2_TEXT = ("*🤙Успешно*\n\nПоздравляю, Вы приобрели свой первый Grow-box. Вы уже в деле! У Вас дома "
                     ...
                     + "урожай для продажи.\n\n")
TRAIN_NICK_TEXT = ("*📝 Название компании*\n\nВаша drug-компания пока никак не называется. Вы можете придумать для "
...
HIGH_GROWING_PURCHASE = ("👍 *Успешно!*\n\n*{desc}* установлена и посажена, теперь вам нужно лишь заходить на ферму "
                         + "и собирать созревшие шишки🌳. Вы можете установить сколько угодно гровбоксов!")
...
LAST_COLLECT = 6
RIPENING = {"MINUTE": 23}
FARM_DESC_START = ("\n\nЗдесь установлены купленные вами гровбоксы. В них созревают 🌳, которые вам необходимо "
                   + "собирать и продавать. Ниже вы можете посмотреть сколько 🌳 выросло в Ваших гровбоксах с "
